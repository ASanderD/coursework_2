...
class JavaQuestionServiceTest {
    ...
    public void beforeEach() {
        ...
        out.add(new Question("Сколько бит занимает целое число типа int", "32"));
        out.add(new Question("Сколько бит занимает целое число типа long", "64"));
        out.add(new Question("Сколько бит занимает число с плавающей точкой типа float", "32"));
    }
    ...
    void getRandomQuestion() {
        ...
        assertThat(actual).isIn(out.getAll());
    }
}